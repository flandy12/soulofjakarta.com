...
<body>
    ...
    <!-- start navbar -->
    <div
        class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-black p-6 border-b border-gray-300">
        ...
        <div id="navbar"
            ...
            <div class="flex flex-row-reverse items-center">
              ...
              <h1 class="text-sm text-gray-100 font-semibold m-0 p-0 leading-none">{{Auth::user()->name}} </h1>
    ...
    <div class="flex flex-row flex-wrap text-black">
        <div id="sideBar"
            ...
            <div class="flex flex-col">
                ...
                <p class="uppercase text-xs text-gray-600 mb-4 mt-4 tracking-wider">Pages</p>
                ...
                <!-- link -->
                <button class="border-amber-500 rounded-md">
                    <!-- Authentication -->
