        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 lg:p-0 md:p-0">
                <div class="flex flex-col sm:m-8">
                    <form method="POST" action="{{url('update-artikel/'.$dbartikel->id)}}"
                        ...
                        <div class="form-group mb-6">
                            <div class="col-span-6 my-3 sm:col-span-3">
                                ...
                                <select id="kategori" name="kategori" autocomplete="kategori-name"
                                    ...
                                    <option value="{{ $category->id_article }}" {{($dbartikel->id_category === $category->id_article ? 'selected' : '')}} >{{$category->nama}}</option>
                                    @endforeach
                            ...
                            <div class="form-group mb-6">
                                <div class="col-span-6 my-3 sm:col-span-3">
                                    ...
                                    <option value="{{ $subkategori->id_sub_category }}" {{($dbartikel->id_sub_category === $subkategori->id_sub_category ? 'selected' : '')}} >{{$subkategori->nama}}</option>
                                    @endforeach
                            ...
                            <div class="form-group mb-6">
                                <label for="exampleInputPassword1"
                                    class="form-label inline-block mb-2 text-gray-700">Foto
                                    Artikel </label>
                                <div class="flex">
                                    <div class="mb-3 w-96">
