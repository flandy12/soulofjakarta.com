                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div
                                            ...
                                            <div>
                                                <p class="statistics-title">User Total</p>
                                                <h3 class="rate-percentage">{{$valueUser->count()}}</h3>
                                                <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>
                                                    </span></p>
                                            </div>
                                            <div class="d-none d-md-block">
                                                <p class="statistics-title">Pending Article</p>
                                                <h3 class="rate-percentage">2</h3>
                                                <p class="text-success d-flex"><i
                                                        class="mdi mdi-menu-down"></i><span>+0.8%</span></p>
                                            </div>
                                            <div class="d-none d-md-block">
                                                <p class="statistics-title">Advertising Total</p>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex ">
                                                                                ...
                                                                                <div class="content-table">
                                                                                    <h6 id="judul">Brandon Washington ascsacsacsa ascascas scsacsa a ascasx csasacas cascasx</h6>
                                                                                    <p>Head admin</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
