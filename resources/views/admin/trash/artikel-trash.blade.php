...
<div class="lg:py-32 bg-gray-100 mx-8 my-3">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
     <a href="{{route('artikel')}}"><span class="bg-blue-500 p-2 my-5 rounded">View Artikel</span></a>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <div class="flex space-x-2 justify-center items-center mr-3">
                                               <a href="{{url('restote-artikel/'.$artikel->id)}}">
                                                    <button type="button"
