...
<div class="flex-1 p-8 md:mt-16 ">
    <div class="mx-auto container  rounded-sm">
        <div class="title p-2 bg-teal-400 my-3 w-32 rounded-md text-black text-center border-2">
            ADD Artikel</div>
        <div class="bg-white text-black overflow-hidden shadow-xl  sm:rounded-lg p-4 lg:p-0 md:p-0">
            <div class="flex text-black flex-col sm:m-8">
