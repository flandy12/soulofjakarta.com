...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.btn-hps').on("click", function () {
  var hps = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('id');
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    type: 'get',
    dataType: "json",
    url: "/delete-artikel/".concat(hps),
    success: function success(data) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#success-delete').text(data.status);
      setTimeout(function () {
        location.reload();
      }, 2000);
    }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".post-thumbnail").on("click", function () {
  var dataId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("id");
  var TitleArtikel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.post-content').find('.post-title');
  var ImageHead = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#ImageHead");
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    type: 'get',
    url: "/artikel/".concat(dataId),
    dataType: 'json',
    success: function success(res) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(TitleArtikel).html(res.judul);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(ImageHead).attr("src", "storage/".concat(res.gambar_besar));
    }
  });
}); //Action Notif Close 
